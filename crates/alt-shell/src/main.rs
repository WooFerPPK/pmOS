...
//!
//! This binary clones `/usr/bin/shell`'s entry point with a
//! single line changed: `taskbar.set_theme(Theme::DARK)` before
//! handing it to `run_desktop_shell`.
...
mod wasm_main {
    ...
    pub fn run() {
        ...
        taskbar.set_theme(toolkit::theme::Theme::DARK);
