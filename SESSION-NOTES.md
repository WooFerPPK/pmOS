...
`(pending) feat(001-browser-os-v1): display-server-lite — user wasm drives pixels end-to-end.`

Branch `001-browser-os-v1`. Workspace totals at this commit: **Rust 833 / TS 258 / 1091 passing, 0 failing.**
