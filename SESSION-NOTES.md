...
`(pending) feat(001-browser-os-v1): kernel opcode breadth #3 — args/environ/fdstat/prestat bootstrap quartet.`

Branch `001-browser-os-v1`. Workspace totals at this commit: **Rust 840 / TS 258 / 1098 passing, 0 failing.**
